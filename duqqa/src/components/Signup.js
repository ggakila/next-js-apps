...
export default function Signup() {
  ...
  return (
    <div className="border rounded-lg overflow-hidden grid grid-cols-2 lg:w-1/2 lg:h-1/2 bg-white shadow-sm leading-loose tracking-wide">
      <div className="left flex flex-col flex-1 items-center justify-center bg-black text-white p-32">
        <span className="text-6xl font-bold font-tilt p-2">duqqa</span>
        <h1 className="text-2xl p-2"> Welcome back</h1>
        <p className="text-sm text-gray-400 p-2">Don't have an account?</p>
        <button
          className="bg-black border border-gray-500 text-gray-200 hover:bg-gray-100 hover:text-gray-700 py-2 my-2 px-4 rounded-full w-full"
          type="submit"
        >
          Sign up
        </button>
      ...
      <div className="flex right flex-1 flex-col items-center justify-center relative">
        ...
        <form className="text-left" onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            />
            {userData.emailError && <p className="text-red-500">{userData.emailError}</p> }
          ...
          <div className="mb-4">
            ...
            />
            {userData.passError && <p className="text-red-500">{userData.passError}</p> }
          </div>
